...
| 7.2 | Téléchargement **1 clic** + gestion stockage / mise à jour | **Largement OK** : auto, bouton profil, progression, reprise SHA, taille locale, **retries** par lot ; affinages UX au besoin terrain |
