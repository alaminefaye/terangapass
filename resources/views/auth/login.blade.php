...
<div class="card">
    <div class="card-body">
        ...
        <!-- /Logo -->
        <h4 class="mb-2">Bienvenue sur {{ config('app.name', 'Teranga Pass') }} ! 👋</h4>
        ...
        <form id="formAuthentication" class="mb-3" action="{{ route('login') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('email') is-invalid @enderror" id="email" name="email" placeholder="Entrez votre email ou nom d'utilisateur" autofocus value="{{ old('email') }}" />
                @error('email')
            ...
            <div class="mb-3">
                <button class="btn btn-primary d-grid w-100 login-submit-btn" type="submit">Se connecter</button>
            </div>
        </form>
