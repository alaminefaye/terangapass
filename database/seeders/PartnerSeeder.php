...
class PartnerSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $partners = [
            ...
            // Banques / DAB, stations, boutiques (module « À deux pas »)
            [
                'name' => 'Agence BIS Plateau',
                'category' => 'bank',
                'description' => 'Agence bancaire avec DAB en centre-ville.',
            ...
            [
                'name' => 'DAB Ecobank Mermoz',
                'category' => 'bank',
                'description' => 'Distributeur automatique 24h.',
                'address' => 'Route de l\'Aéroport, Mermoz, Dakar',
                'latitude' => 14.7072,
                'longitude' => -17.4758,
                'phone' => null,
                'email' => null,
            ...
            [
                'name' => 'Station Shell Ouakam',
                'category' => 'gas_station',
                'description' => 'Carburants et lavage.',
                'address' => 'Route de l\'Aéroport, Ouakam, Dakar',
                'latitude' => 14.7234,
                'longitude' => -17.4932,
                'phone' => '+221338765432',
                'email' => null,
            ...
            [
                'name' => 'Marché Sandaga (boutiques)',
                'category' => 'shop',
                'description' => 'Artisanat et textiles.',
                'address' => 'Sandaga, Dakar Plateau',
                'latitude' => 14.6698,
                'longitude' => -17.4304,
                'phone' => null,
                'email' => null,
